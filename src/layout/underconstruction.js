...
const UnderConstruction = () => {
  return (
    <div className="flex flex-col items-center h-[100vh] justify-center bg-gray-100 text-gray-800">
        <img
      ...
      <h1 className="mt-4 text-4xl font-bold">We're Under Construction</h1>
